...
if ($row_admin && isset($row_admin['admin_id'])) {
    $admin_id = $row_admin['admin_id'];
} else {
    $admin_id = "Default Admin ID"; // or handle the null case appropriately
}


if ($row_admin && isset($row_admin['admin_name'])) {
    $admin_name = $row_admin['admin_name'];
} else {
    $admin_name = "Default Admin Name"; // or handle the null case appropriately
}


if ($row_admin && isset($row_admin['admin_email'])) {
    $admin_email = $row_admin['admin_email'];
} else {
    $admin_email = "Default Admin Email"; // or handle the null case appropriately
}


if ($row_admin && isset($row_admin['admin_image'])) {
    $admin_image = $row_admin['admin_image'];
} else {
    $admin_image = "Default Admin Image"; // or handle the null case appropriately
}


if ($row_admin && isset($row_admin['admin_country'])) {
    $admin_country = $row_admin['admin_country'];
} else {
    $admin_country = "Default Admin Country"; // or handle the null case appropriately
}


if ($row_admin && isset($row_admin['admin_job'])) {
    $admin_job = $row_admin['admin_job'];
} else {
    $admin_job = "Default Admin Job"; // or handle the null case appropriately
}


if ($row_admin && isset($row_admin['admin_contact'])) {
    $admin_contact = $row_admin['admin_contact'];
} else {
    $admin_contact = "Default Admin Contact"; // or handle the null case appropriately
}




if ($row_admin && isset($row_admin['admin_about'])) {
    $admin_about = $row_admin['admin_about'];
} else {
    $admin_about = "Default Admin About"; // or handle the null case appropriately
}
